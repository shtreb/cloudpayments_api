...
_RecurrentInfo _$RecurrentInfoFromJson(Map<String, dynamic> json) =>
    _RecurrentInfo(
      ...
      lastTransactionDateIso:
          json['LastTransactionDateIso'] == null
              ? null
      ...
      nextTransactionDateIso:
          json['NextTransactionDateIso'] == null
              ? null
...
Map<String, dynamic> _$RecurrentInfoToJson(
  _RecurrentInfo instance,
) => <String, dynamic>{
  'Id': instance.id,
  ...
  'LastTransactionDateIso': instance.lastTransactionDateIso?.toIso8601String(),
  'NextTransactionDate': instance.nextTransactionDate,
  'NextTransactionDateIso': instance.nextTransactionDateIso?.toIso8601String(),
